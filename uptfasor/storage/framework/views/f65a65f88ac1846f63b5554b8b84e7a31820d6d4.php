        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="app-navbar-collapse">
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <?php else: ?>
                        <li><a href="<?php echo e(route('reservasi.index')); ?>">Reservasi</a></li>
                        <li><a href="<?php echo e(route('courts.index')); ?>">Lapangan</a></li>
                        <li><a href="<?php echo e(route('user.index')); ?>">Penyewa</a></li>
                        <li class="dropdown">
